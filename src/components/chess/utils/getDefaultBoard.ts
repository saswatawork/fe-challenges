...
export const getDefaultBoard = (): ChessBoard => {
  ...
  return Array.from({ length: CONFIG.ROW }, (_, row) =>
    Array.from({ length: CONFIG.COL }, (_, col) => {
      ...
      // The Pawn
      if (row === 1 || row === 6) {
        return { player: baseChessItem[row], piece: ChessPieces.PAWN };
      }
      ...
      if (row === 0 || row === 7) {
        switch (col) {
          ...
          case 0:
          case 7:
            return { player: baseChessItem[row], piece: ChessPieces.ROOK };
          // The Knight
          case 1:
          case 6:
            return { player: baseChessItem[row], piece: ChessPieces.KNIGHT };
          // The Bishop
          case 2:
          case 5:
            return { player: baseChessItem[row], piece: ChessPieces.BISHOP };
          // The Queen
          case 3:
            return { player: baseChessItem[row], piece: ChessPieces.QUEEN };
          // The King
          case 4:
            return { player: baseChessItem[row], piece: ChessPieces.KING };
          default:
            break;
        }
      }
